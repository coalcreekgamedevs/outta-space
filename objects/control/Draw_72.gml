...
draw_sprite_tiled(bg_sky, 3, camera_get_view_x(view_camera[0]) / 3, camera_get_view_y(view_camera[0]) + (3 * sin(flow / 500)) - 6 - (130 * (camera_get_view_y(view_camera[0]) / room_height)));
